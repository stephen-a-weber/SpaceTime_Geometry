...
class Data: ObservableObject {
    @Published var rings = 0
    @Published var pictureLocations = [[Double]]()
@Published var AllLocations = [[Double]]()
    @Published  var direction =
    [0.0,3.0,0.0]
  //  [4.0,6.0,3.0] one et two
        //[2.0,4.0,1.0]// two et one
   // [2.0,1.0,1.0] they all are the same
    @Published var MagneticDrawColor = true
  ...
  @Published var whichRing = [0]
   ...
   var Cy =  0.0
    ...
    init() {
      ...
      //  self.direction = [1,2,3]
        ...
        unit.append(CGPoint(x: x + ex - c1   ,y: y + ey ))
        makeLocation()
       makePictureLocations()
        makeAllLocations()
    }
    func makeAllLocations() {
        
        var x = -900.0
        var y = -900.0
                    for x in [-1050.0, -950.0] {
                        for y in  [-100.0,50.0] {
                            print(x,y)
   ...
   //     pictureLocations.append([-975.0,0.0])
        
                    for x in [-700.0, -600.0] {
                        for y in  [-550.0,-400.0,-250.0,-100.0,50.0,200.0,350.0,500.0]{
                            print(x,y)
                           AllLocations.append([x,y])
                        }
                    }
...
//        pictureLocations.append([-625.0,-200])
//        pictureLocations.append([-625.0,200.0])
        
        
        
                    for x in [-300.0, -200.0,100,200]  {
                        for y in  [-550.0,-400.0,-250.0,-100.0,50.0,200.0,350.0,500.0] {
                            print(x,y)
                            AllLocations.append([x,y])
                        }
...
//        pictureLocations.append([-200,-325.0])
//        pictureLocations.append([-200.0,300.0])
//        pictureLocations.append([200.0,-325.0])
//        pictureLocations.append([200.0,300.0])
 
        
        
        for x in [500.0,600.0,900.0,1000.0] {
                        for y in  [-400.0,-250.0] {
                            print(x,y)
                            AllLocations.append([x,y])
                        }
                    }

        for x in [500,600,900.0,1000.0] {
            for y in  [50.0,200.0,350.0,500.0] {
                print(x,y)
                AllLocations.append([x,y])
            }
        }
...
//        pictureLocations.append([700.0,-475.0])
//        pictureLocations.append([1000.0,0.0])
//        pictureLocations.append([700.0,-175.0])
//        pictureLocations.append([700.0,275.0])
        
        
    }
    func makePictureLocations() {
        var x = -900.0
        var y = -900.0
//        for x in [-1050.0, -900.0] {
//            for y in  [-100.0,100.0] {
//                print(x,y)
//            pictureLocations.append([x,y])
//        }
//        }
        pictureLocations.append([-975.0,0.0])
        
//        for x in [-700.0, -550.0] {
//            for y in  [-300.0,-100.0,100.0,300.0] {
//                print(x,y)
//                pictureLocations.append([x,y])
//            }
//        }
